...
# Эта функция для позитивных проверок
...
# Тест 3. Некорректное имя при создании пользователя
# Параметр firstName состоит из 1 символа

# Эта функция для негативных проверок
...
# Тест 4. Некорректное имя при создании пользователя
# Параметр firstName состоит из 16 символов

def test_create_user_16_letter_in_first_name_get_error_response():
    negative_assert_symbol("Аааааааааааааааа")

# Тест 5. Создание пользователя (разрешены английские буквы)
# Параметр firstName состоит из английских букв

def test_create_user_english_letter_in_first_name_get_success_response():
    positive_assert("QWErty")

# Тест 6. Создание пользователя (разрешены русские буквы)
# Параметр firstName состоит из русских букв

def test_create_user_russian_letter_in_first_name_get_success_response():
    positive_assert("Мария")

# Тест 7. Некорректное имя при создании пользователя
# В параметре firstName запрещены пробелы

def test_create_user_has_space_in_first_name_get_error_response():
    negative_assert_symbol("Человек и Ко")

# Тест 8. Некорректное имя при создании пользователя
# В параметре firstName запрещены спецсимволы

def test_create_user_has_special_symbol_in_first_name_get_error_response():
    negative_assert_symbol("\@№%@\",")

# Тест 9. Некорректное имя при создании пользователя
# В параметре firstName запрещены цифры

def test_create_user_has_number_in_first_name_get_error_response():
    negative_assert_symbol("123")

# Функция для пустых имен
...
# Тест 10. Некорректное имя при создании пользователя
# Параметр firstName не передаётся в запросе
...
# Тест 12. Некорректное имя при создании пользователя
# В параметре firstName передаётся не другой тип (число)
